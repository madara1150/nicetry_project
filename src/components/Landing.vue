<template>
  <div>
    ...
    <div class="flex px-64 max-[600px]:flex-col max-[600px]:px-0 mt-20">
      ...
      <div
        class="ml-10 text-white w-[55%] p-10 flex items-center max-[600px]:w-full max-[600px]:ml-0"
      >
    ...
    <hr class="h-px my-8 bg-gray-200 border-0" />
    <!-- post -->
    <div class="flex px-64 mt-20">
      
      <!-- card -->
      <div class="w-[45%] max-[600px]:w-[100%]">
        <div
          class="w-full h-full drop-shadow-[0_45px_45px_rgba(0,255,255,0.6)]"
        >
          <!-- profile -->
          <div
            class="flex items-center bg-gradient-to-br from-gray-800 via-gray-800 to-slate-700 p-2 rounded-t-xl w-full"
          >
            <img
      ...
      >
        <p class="max-[600px]:inline-block">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi quas totam dolorem pariatur aperiam deleniti minima optio aspernatur animi perspiciatis!
        </p>
      </div>
