          ...
          <div class="flex flex-col justify-start w-full">
            ...
            >
              ...
              >
                ...
                <div
                  class="relative float-left -mr-[100%] hidden w-full h-[300px] !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
                  data-te-carousel-fade
                  data-te-carousel-item
                >
                  <img
